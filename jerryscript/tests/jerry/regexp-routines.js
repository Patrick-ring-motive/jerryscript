...
Object.defineProperty(o, 'multiline', {
  'get': function() {
    throw "abrupt flag get";
  }
});
try {
  o.flags
...
Object.defineProperty(o, 'unicode', {
  'get': function() {
    throw "abrupt unicode get";
  }
});
try {
...
var subject = /initial/;
Object.defineProperty(subject, 'lastIndex', {
  value: 45,
  writable: false
});
